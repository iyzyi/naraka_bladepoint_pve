...
PS：如果不想刷武器熟练度，而是想刷通币任务、账号等级、通行证等级等，我建议选宁红夜（必带蓝月、选带天蚕茧），刷起来速度更快，即使是没怎么打过征神的萌新，也能有较快的速度。我下面的魂玉搭配能在大概80秒内打完：

![image-20240710183448695](http://image.iyzyi.com/img/202407101837245.png)
