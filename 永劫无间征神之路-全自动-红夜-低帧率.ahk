	...
	Loop {
        ...
        if (OnLooping = 0) {
			...
			if (pid){
                ...
                if MyImageSearch("Img\失去服务器连接.jpg", 911, 401, 1016, 468) {
                    Send {Space}
                    continue
                }

                if MyImageSearch("Img\公告.jpg", 911, 285, 1007, 352) {
                    Send {Space}
                    continue
                }

                if MyImageSearch("Img\首页.jpg", 1815, 929, 1905, 1056) {
                    Sleep, 500
                ...
                if MyImageSearch("Img\有未完的战斗.jpg", 802, 498, 980, 554) {
